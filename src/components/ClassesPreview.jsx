        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 44, flexWrap: 'wrap', gap: 16 }}>
          <div>
            <div style={{
              ...
              background: 'rgba(234,68,60,.1)', border: '1px solid rgba(234,68,60,.22)',
        ...
        <div style={{ textAlign: 'center', marginTop: 38 }}>
          <button
            ...
            style={{
              ...
              cursor: 'pointer',
              boxShadow: '0 10px 28px rgba(234,68,60,.3)',
              transition: 'all .2s',
            }}
            onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 16px 36px rgba(234,68,60,.45)' }}
            onMouseLeave={e => { e.currentTarget.style.transform = 'none'; e.currentTarget.style.boxShadow = '0 10px 28px rgba(234,68,60,.3)' }}
          >
